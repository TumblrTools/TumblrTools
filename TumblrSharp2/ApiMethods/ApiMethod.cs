namespace TumblrSharp2.ApiMethods
{
    using System;
	...
	public class ApiMethod
	{
		...
		/// </summary>
		public string Url { get { return this.methodUrl; } }
		...
		/// </summary>
		public HttpMethod HttpMethod { get { return this.httpMethod; } }

		/// <summary>
		/// Gets the parameters for the Tumblr API call.
		/// </summary>
		public MethodParameterSet Parameters { get { return this.parameters; } }

        public string ApiRequestUrl()
        {
            StringBuilder urlBuilder = new StringBuilder(this.Url);
            if (this.HttpMethod == HttpMethod.Get && this.Parameters.Count > 0)
            {
                urlBuilder.Append("?");
                urlBuilder.Append(this.Parameters.ToFormUrlEncoded());
            }
