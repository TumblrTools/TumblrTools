namespace TumblrSharp2.ApiMethods.Parameters
{
    ...
    internal class BinaryMethodParameter : IMethodParameter
	{
		...
		{
			var content = new ByteArrayContent(this.value);
			...
			if (!String.IsNullOrEmpty(this.mimeType))
				content.Headers.ContentType = new System.Net.Http.Headers.MediaTypeHeaderValue(this.mimeType);
		...
		{
			return this.Equals(obj as BinaryMethodParameter);
		}

		public override string ToString()
		{
			return String.Format("{0}={{binary}}", this.Name);
		}
	}
}
